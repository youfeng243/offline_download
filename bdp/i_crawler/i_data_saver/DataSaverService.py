...
class Processor(Iface, TProcessor):
  ...
  def process_check_data(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("check_data", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class check_data_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'entity', (bdp.i_crawler.i_entity_extractor.ttypes.EntityExtractorInfo, bdp.i_crawler.i_entity_extractor.ttypes.EntityExtractorInfo.thrift_spec), None, ), # 1
  )
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.entity = bdp.i_crawler.i_entity_extractor.ttypes.EntityExtractorInfo()
