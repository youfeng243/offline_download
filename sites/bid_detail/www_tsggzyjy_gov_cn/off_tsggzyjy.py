...
class TsggzyjyCrawler(TaskBase):
    def __init__(self):
    ...
    def start(self):
        ...
        self.logger.info("开始执行: TsggzyjyCrawler")

        sectionSeeds = []

        buildTender = SectionSeed("建设工程", "http://www.tsggzyjy.gov.cn/InfoPage/InfoList.aspx?SiteItem=36&InfoType=3",
        ...
        landTender = SectionSeed("土地工程", "http://www.tsggzyjy.gov.cn/InfoPage/InfoList.aspx?SiteItem=38&InfoType=3",
                                 "http://www.tsggzyjy.gov.cn/ajax/Controls_InfoList,App_Web_s3hq3q4a.ashx?_method=getTotalPages&_session=rw",
                                 "http://www.tsggzyjy.gov.cn/ajax/Controls_InfoList,App_Web_s3hq3q4a.ashx?_method=getCurrentData&_session=rw")
        sectionSeeds.append(landTender)

        trafficTender = SectionSeed("交通工程", "http://www.tsggzyjy.gov.cn/InfoPage/InfoList.aspx?SiteItem=40&InfoType=3",
                                    "http://www.tsggzyjy.gov.cn/ajax/Controls_InfoList,App_Web_s3hq3q4a.ashx?_method=getTotalPages&_session=rw",
                                    "http://www.tsggzyjy.gov.cn/ajax/Controls_InfoList,App_Web_s3hq3q4a.ashx?_method=getCurrentData&_session=rw")
        sectionSeeds.append(trafficTender)

        waterConservancyTender = SectionSeed("水利工程",
                                             "http://www.tsggzyjy.gov.cn/InfoPage/InfoList.aspx?SiteItem=42&InfoType=3",
                                             "http://www.tsggzyjy.gov.cn/ajax/Controls_InfoList,App_Web_s3hq3q4a.ashx?_method=getTotalPages&_session=rw",
                                             "http://www.tsggzyjy.gov.cn/ajax/Controls_InfoList,App_Web_s3hq3q4a.ashx?_method=getCurrentData&_session=rw")
        sectionSeeds.append(waterConservancyTender)

        gvPurchase = SectionSeed("政府采购", "http://www.tsggzyjy.gov.cn/InfoPage/InfoList.aspx?SiteItem=44&InfoType=3",
                                 "http://www.tsggzyjy.gov.cn/ajax/Controls_InfoList,App_Web_s3hq3q4a.ashx?_method=getTotalPages&_session=rw",
                                 "http://www.tsggzyjy.gov.cn/ajax/Controls_InfoList,App_Web_s3hq3q4a.ashx?_method=getCurrentData&_session=rw")
        sectionSeeds.append(gvPurchase)

        landProperty = SectionSeed("国有土地产权", "http://www.tsggzyjy.gov.cn/InfoPage/InfoList.aspx?SiteItem=46&InfoType=3",
                                   "http://www.tsggzyjy.gov.cn/ajax/Controls_InfoList,App_Web_s3hq3q4a.ashx?_method=getTotalPages&_session=rw",
                                   "http://www.tsggzyjy.gov.cn/ajax/Controls_InfoList,App_Web_s3hq3q4a.ashx?_method=getCurrentData&_session=rw")
        ...
        self.logger.info("执行完成: TsggzyjyCrawler")
