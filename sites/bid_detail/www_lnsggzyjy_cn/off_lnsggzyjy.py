...
class LnsggzyjyCrawler(TaskBase):
    def __init__(self):
        ...
        self.province = "甘肃省"
        self.city = "陇南"
        self.logger.info("初始化完成: LnsggzyjyCrawler")
    ...
    def start(self):
        ...
        self.logger.info("执行完成: LnsggzyjyCrawler")
