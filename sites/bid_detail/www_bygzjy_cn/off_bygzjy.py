...
class BygzjyCrawler(TaskBase):
    ...
    def start(self):
        self.logger.info("开始执行: BygzjyCrawler")
        sectionSeeds = []

        buildTender = SectionSeed("市政、房建工程", "http://www.bygzjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=4TE8hgQqkCk%3D",
        ...
        gvPurchase = SectionSeed("政府采购", "http://www.bygzjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=fVoViMwBm04%3D",
                                 "http://www.bygzjy.cn/Handlers/InfoPageTrade.ashx",
                                 "http://www.bygzjy.cn/Handlers/InfoPageTrade.ashx", 27)
        sectionSeeds.append(gvPurchase)

        resourcesTransaction = SectionSeed("国土、矿权、产权交易",
        ...
        trafficWaterConservancyTender = SectionSeed("交通、水利工程",
        ...
        medicalApparatus = SectionSeed("医疗器械",
                                       "http://www.bygzjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=zJlkEDhqgOY%3D",
                                       "http://www.bygzjy.cn/Handlers/InfoPageTrade.ashx",
        ...
        for sectionSeed in sectionSeeds:
            try:
                ...
                self.logger.exception(e)
        self.logger.info("执行完成: BygzjyCrawler")
