...
class LanzhouCrawler(TaskBase):
    ...
    def start(self):
        self.logger.info("开始执行: LanzhouCrawler")
        sectionSeeds = []

        buildTender = SectionSeed("建设工程", "http://www.lzggzyjy.cn/InfoPage/InfoList.aspx?SiteItem=36",
        ...
        gvPurchase = SectionSeed("政府采购", "http://www.lzggzyjy.cn/InfoPage/InfoList.aspx?SiteItem=40",
        ...
        resourcesTransaction = SectionSeed("国土、矿权、产权交易", "http://www.lzggzyjy.cn/InfoPage/InfoList.aspx?SiteItem=46",
                                           "http://www.lzggzyjy.cn/ajax/Controls_InfoListControl,App_Web_qumnj53o.ashx?_method=getTotalPages&_session=rw",
                                           "http://www.lzggzyjy.cn/ajax/Controls_InfoListControl,App_Web_qumnj53o.ashx?_method=getCurrentData&_session=rw")
        sectionSeeds.append(resourcesTransaction)

        otherTransaction = SectionSeed("其他交易", "http://www.lzggzyjy.cn/InfoPage/InfoList.aspx?SiteItem=49",
                                       "http://www.lzggzyjy.cn/ajax/Controls_InfoListControl,App_Web_qumnj53o.ashx?_method=getTotalPages&_session=rw",
                                       "http://www.lzggzyjy.cn/ajax/Controls_InfoListControl,App_Web_qumnj53o.ashx?_method=getCurrentData&_session=rw")
        sectionSeeds.append(otherTransaction)

        countyTender = SectionSeed("区县项目招标", "http://www.lzggzyjy.cn/InfoPage/InfoList.aspx?SiteItem=52",
                                   "http://www.lzggzyjy.cn/ajax/Controls_InfoListControl,App_Web_qumnj53o.ashx?_method=getTotalPages&_session=rw",
                                   "http://www.lzggzyjy.cn/ajax/Controls_InfoListControl,App_Web_qumnj53o.ashx?_method=getCurrentData&_session=rw")
        ...
        self.logger.info("执行完成: LanzhouCrawler")
