...
class WwggzyPublicResourceTenderWorker(TaskBase):
    def __init__(self):
    ...
    def start(self):
        ...
        self.logger.info("开始执行: WwggzyPublicResourceTenderWorker")
        sectionSeeds = []

        buildTender = ssd("建设工程", "http://www.wwggzy.com/InfoPage/InfoList.aspx?SiteItem=29",
        ...
        trafficTender = ssd("交通工程", "http://www.wwggzy.com/InfoPage/InfoList.aspx?SiteItem=37",
                            "http://www.wwggzy.com/ajax/Controls_InfoListControl,App_Web_m1c2wyi1.ashx?_method=getTotalPages&_session=rw",
                            "http://www.wwggzy.com/ajax/Controls_InfoListControl,App_Web_m1c2wyi1.ashx?_method=getCurrentData&_session=rw")
        sectionSeeds.append(trafficTender)

        waterConservancyTender = ssd("水利工程", "http://www.wwggzy.com/InfoPage/InfoList.aspx?SiteItem=42",
                                     "http://www.wwggzy.com/ajax/Controls_InfoListControl,App_Web_m1c2wyi1.ashx?_method=getTotalPages&_session=rw",
                                     "http://www.wwggzy.com/ajax/Controls_InfoListControl,App_Web_m1c2wyi1.ashx?_method=getCurrentData&_session=rw")
        sectionSeeds.append(waterConservancyTender)

        gvPurchase = ssd("政府采购", "http://www.wwggzy.com/InfoPage/InfoList.aspx?SiteItem=48",
                         "http://www.wwggzy.com/ajax/Controls_InfoListControl,App_Web_m1c2wyi1.ashx?_method=getTotalPages&_session=rw",
                         "http://www.wwggzy.com/ajax/Controls_InfoListControl,App_Web_m1c2wyi1.ashx?_method=getCurrentData&_session=rw")
        sectionSeeds.append(gvPurchase)

        propertyTender = ssd("产权交易", "http://www.wwggzy.com/InfoPage/InfoList.aspx?SiteItem=56",
                             "http://www.wwggzy.com/ajax/Controls_InfoListControl,App_Web_m1c2wyi1.ashx?_method=getTotalPages&_session=rw",
                             "http://www.wwggzy.com/ajax/Controls_InfoListControl,App_Web_m1c2wyi1.ashx?_method=getCurrentData&_session=rw")
        sectionSeeds.append(propertyTender)

        landTender = ssd("土地整理", "http://www.wwggzy.com/InfoPage/InfoList.aspx?SiteItem=59",
                         "http://www.wwggzy.com/ajax/Controls_InfoListControl,App_Web_m1c2wyi1.ashx?_method=getTotalPages&_session=rw",
                         "http://www.wwggzy.com/ajax/Controls_InfoListControl,App_Web_m1c2wyi1.ashx?_method=getCurrentData&_session=rw")
        ...
        self.logger.info("执行完成: WwggzyPublicResourceTenderWorker")
...
if __name__ == "__main__":
    worker = WwggzyPublicResourceTenderWorker()
    worker()
