...
class GnggzyjyPublicResourceTenderWorker(TaskBase):
    def __init__(self):
    ...
    def start(self):
        self.logger.info("开始执行: GnggzyjyPublicResourceTenderWorker")
        sectionSeeds = []
        ...
        resourcesTransaction = ssd("土地及产权交易", "http://www.gnggzyjy.com/InfoPage/InfoList.aspx?SiteItem=29",
        ...
        self.logger.info("执行完成: GnggzyjyPublicResourceTenderWorker")
...
if __name__ == "__main__":
    worker = GnggzyjyPublicResourceTenderWorker()
    worker()
