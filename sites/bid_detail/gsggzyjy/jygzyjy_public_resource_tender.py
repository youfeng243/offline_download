...
class JygzyjyPublicResourceTenderWorker(TaskBase):
    def __init__(self):
    ...
    def start(self):
        self.logger.info("开始执行: JygzyjyPublicResourceTenderWorker")
        sectionSeeds = []

        # buildTender = ssd("建设工程", "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=26&query=",
        #                   "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=26&query=",
        #                   "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=26&page={pageIndex}&query=")
        # sectionSeeds.append(buildTender)
        #
        # gvPurchase = ssd("政府采购", "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=30&query=",
        #                   "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=30&query=",
        #                   "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=30&page={pageIndex}&query=")
        # sectionSeeds.append(gvPurchase)
        #
        # resourcesTransaction = ssd("土地矿产", "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=37&query=",
        #                  "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=37&query=",
        #                  "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=37&page={pageIndex}&query=")
        # sectionSeeds.append(resourcesTransaction)
        #
        # propertyTransaction = ssd("产权交易", "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=41&query=",
        #                            "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=41&query=",
        #                            "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=41&page={pageIndex}&query=")
        # sectionSeeds.append(propertyTransaction)
        #
        # medicalTender = ssd("医疗器械 ", "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=45&query=",
        #                           "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=45&query=",
        #                           "http://www.jygzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=45&page={pageIndex}&query=")
        ...
        self.logger.info("执行完成: JygzyjyPublicResourceTenderWorker")
...
if __name__ == "__main__":
    worker = JygzyjyPublicResourceTenderWorker()
    worker()
