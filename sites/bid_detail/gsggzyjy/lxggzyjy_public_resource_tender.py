...
class LxggzyjyPublicResourceTenderWorker(TaskBase):
    def __init__(self):
    ...
    def start(self):
        ...
        self.logger.info("开始执行: LxggzyjyPublicResourceTenderWorker")
        ...
        buildTender = ssd("建设工程", "http://www.lxggzyjy.com/InfoPage/InfoList.aspx?SiteItemID=31",
        ...
        gvPurchase = ssd("政府采购", "http://www.lxggzyjy.com/InfoPage/InfoList.aspx?SiteItemID=33",
                         "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getTotalPages&_session=rw",
                         "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getCurrentData&_session=rw")
        sectionSeeds.append(gvPurchase)

        trafficTender = ssd("交通项目", "http://www.lxggzyjy.com/InfoPage/InfoList.aspx?SiteItemID=39",
                            "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getTotalPages&_session=rw",
                            "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getCurrentData&_session=rw")
        sectionSeeds.append(trafficTender)

        waterConservancyTender = ssd("水利项目", "http://www.lxggzyjy.com/InfoPage/InfoList.aspx?SiteItemID=62",
                                     "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getTotalPages&_session=rw",
                                     "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getCurrentData&_session=rw")
        sectionSeeds.append(waterConservancyTender)

        comprehensiveTender = ssd("综合项目", "http://www.lxggzyjy.com/InfoPage/InfoList.aspx?SiteItemID=81",
                                  "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getTotalPages&_session=rw",
                                  "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getCurrentData&_session=rw")
        sectionSeeds.append(comprehensiveTender)

        resourcesTransaction = ssd("国土、矿权、产权交易", "http://www.lxggzyjy.com/InfoPage/InfoList.aspx?SiteItemID=35",
                                   "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getTotalPages&_session=rw",
                                   "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getCurrentData&_session=rw")
        sectionSeeds.append(resourcesTransaction)

        landTender = ssd("国土项目", "http://www.lxggzyjy.com/InfoPage/InfoList.aspx?SiteItemID=80",
                         "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getTotalPages&_session=rw",
                         "http://www.lxggzyjy.com" + ajaxUrlFlag + "?_method=getCurrentData&_session=rw")
        ...
        self.logger.info("执行完成: LxggzyjyPublicResourceTenderWorker")
...
if __name__ == "__main__":
    worker = LxggzyjyPublicResourceTenderWorker()
    worker()
