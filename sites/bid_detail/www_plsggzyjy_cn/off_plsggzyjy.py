...
class PlsggzyjyCrawler(TaskBase):
    def __init__(self):
    ...
    def start(self):
        self.logger.info("开始执行: PlsggzyjyCrawler")

        sectionSeeds = []

        buildTender = SectionSeed("房建工程", "http://www.plsggzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=26",
        ...
        municipalTender = SectionSeed("市政工程", "http://www.plsggzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=27",
                                      "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx",
                                      "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx", 27)
        sectionSeeds.append(municipalTender)

        trafficTender = SectionSeed("交通工程", "http://www.plsggzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=28",
                                    "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx",
                                    "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx", 28)
        sectionSeeds.append(trafficTender)

        waterConservancyTender = SectionSeed("水利工程", "http://www.plsggzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=29",
                                             "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx",
                                             "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx", 29)
        sectionSeeds.append(waterConservancyTender)

        gvPurchase = SectionSeed("政府采购", "http://www.plsggzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=31",
                                 "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx",
                                 "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx", 31)
        sectionSeeds.append(gvPurchase)

        landResources = SectionSeed("国土资源", "http://www.plsggzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=32",
                                    "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx",
                                    "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx", 32)
        sectionSeeds.append(landResources)

        resourcesTransaction = SectionSeed("矿权产权", "http://www.plsggzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=33",
                                           "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx",
                                           "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx", 33)
        sectionSeeds.append(resourcesTransaction)

        landProperty = SectionSeed("土地整理", "http://www.plsggzyjy.cn/InfoPage/InfoListInfo.aspx?SiteItem=169",
                                   "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx",
        ...
        self.logger.info("执行完成: PlsggzyjyCrawler")
